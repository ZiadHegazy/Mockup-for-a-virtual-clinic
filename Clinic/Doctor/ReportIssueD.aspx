<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ReportIssueD.aspx.cs" Inherits="Clinic.Doctor.ReportIssueD" %>
...
<head runat="server">
    <title></title>
    <link href="ReportIssueD.css" rel="stylesheet" />
</head>
    ...
    <form id="form1" runat="server">
      ...
      <div class="translateUp10">
       ...
       <ul>
         ...
         <li  runat="server" class="normal" ><a href="Appointments.aspx"  >Appointments</a></li>
           ...
           <li id="addpubLabel" runat="server" class="normal"> <a href="DiscussionDoctor.aspx"  >Discussion Board</a>
            <!-- <div id="hidden_area2"  runat="server" class="hidden_area2">student does not have any on going thesis</div>
              -->
                               ...
                               <div class="loginbox3">
                    <label  class="p4" > Reporting an Issue ! </label>
         <asp:TextBox  runat ="server" CssClass="txtname" placeholder="What do you want to report ?" ID="text" />
        <asp:Button Text="Submit" CssClass="confirm" runat="server" id="confirm" OnClick="confirm_Click"  />
        </div>
