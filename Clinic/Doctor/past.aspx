<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="past.aspx.cs" Inherits="Clinic.past" %>
         ...
         -->
            ...
            <div class="loginbox1">
             <img src="../img/man.png"  alt =" Alternative Text" class ="man1"/> 
                 <label for="patient1" class="p1" > sara mohamed saad </label>
                <label for="patient1_age" class="p2" > Age : 26 ys </label>
                <label for="time1" class="p3" > Time : 1 pm </label>
                <asp:Button Text="Send Message" CssClass="re" runat="server"  ID="send1" OnClick="send1_Click"  />
                <asp:Button Text="View Patient Profile" CssClass="med" runat="server" OnClick="Unnamed2_Click"  />


        </div>

         <div class="loginbox3"  runat="server"  >
             <img src="../img/man.png"  alt =" Alternative Text" class ="man1"/> 
             <label id="patient2" class="p1"> khaled elgohary  </label>
             <label id="patient1_age" class="p2" > Age : 28 ys </label>
             <label id="time1" class="p3" > Time : 7:30 pm </label>
             <asp:Button Text="Send Message" CssClass="re" runat="server"  id="send2" OnClick="send2_Click"/>
             <asp:Button Text="View Patient Profile" CssClass="med" runat="server" OnClick="Unnamed4_Click"   />
