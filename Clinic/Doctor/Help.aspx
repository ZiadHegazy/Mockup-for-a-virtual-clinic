<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Help.aspx.cs" Inherits="Clinic.Doctor.Help" %>
       ...
       <ul>
           ...
           <li id="addpubLabel" runat="server" class="normal" ><a href="MyPatients.aspx"  >Patients</a>
               ...
               <img src="../img/FAQ.jpg"  alt =" Alternative Text" class ="faq"/>
                        ...
                        <asp:HyperLink ID="HyperLink1" href="Question.aspx" CssClass="question" Font-Underline="true" Font-Bold="True"  runat="server">Have another question ? </asp:HyperLink>
                        </div>
