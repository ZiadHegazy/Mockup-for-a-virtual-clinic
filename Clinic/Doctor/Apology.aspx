<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Apology.aspx.cs" Inherits="Clinic.Doctor.Apology" %>

<!DOCTYPE html>
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title></title>
    <link href="Apology.css" rel="stylesheet" />
</head>
       ...
       <ul>
         ...
         -->
                      ...
                      <li id="Li1" runat="server" class="normal" ><a href="DiscussionDoctor.aspx"  >Discussion Board</a> 
                                      ...
                                      <div class="loginbox3">
                    <label  class="p4" > Reasons Of Delay   ! </label>
         <asp:TextBox  runat ="server" CssClass="txtname" placeholder="State The Reasons" ID="text" />
