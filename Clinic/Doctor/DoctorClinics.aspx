<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DoctorClinics.aspx.cs" Inherits="Clinic.Doctor.DoctorClinics" %>
       ...
       <div class ="loginbox2"> 
        ...
        <div class="text">
            <asp:MultiView ID="MultiView2" runat="server">
                    ...
                    <asp:Label ID="stufirstname" Text= "Clinic Name : Al safwa"  CssClass="lblcard" runat ="server" />
                    ...
                    <br /><br />
                          ...
                          <asp:Label ID="Label1" Text="Landline number:0225303737" CssClass="lblcard44" runat ="server" />
                  ...
                  <br /><br />
                    ...
                    <asp:Label  ID="stufaculty" Text="phone :01123204458" CssClass="lblcard"  runat="server" />
                  ...
                  <br /><br />
                    ...
                    <div class="vl5"></div>
                    <asp:Label ID="stuemail" Text="Location : New Cairo" CssClass="lblcard" runat ="server" />
              <asp:ImageButton ID="ImageButton4" src="../img/edit-button-1551.png" Width="25px" Height="25px" CssClass="editButt" runat="server" OnClick="ImageButton4_Click" />
                                   ...
                                   <asp:Button Text="Remove Clinic" CssClass="btnsubmit4" width="140px" Height ="50px"  runat="server" OnClick="remove" />
                          ...
                          <asp:View ID= "View3"  runat= "server"> 
                           <div class="view3">
                                     <asp:TextBox ID="TextBox1" runat="server"  required="true" placeholder="Enter your new phone number" width="300px" CssClass="txtname"></asp:TextBox>
                                    <asp:Button id="Button1" Text="confirm"  CssClass="confirm" width="100px" Height ="50px"  runat="server" OnClick="confirmPhone_Click"  />
                                     <asp:Button id="Button2" Text="Cancel"  CssClass="confirm5" width="100px" Height ="50px" CausesValidation="false" runat="server" OnClick="cancel" UseSubmitBehavior="False" ValidateRequestMode="Disabled" ValidationGroup="no"  />
                ...
                <div class="view3">
                                ...
                                <h5 class="uploadtxt">kindly enter your new Location</h5>
                                  <asp:TextBox ID="TextBox7" runat="server" required="true" placeholder="Enter new location" CssClass="txtname2"></asp:TextBox>
                </div>
                ...
                <asp:View ID= "View6" runat= "server"> 
                                   <asp:TextBox ID="TextBox6" runat="server"  required="true" placeholder="Enter your new phone number" width="300px" CssClass="txtname"></asp:TextBox>
                                    <asp:Button id="Button8" Text="confirm"  CssClass="confirm" width="100px" Height ="50px"  runat="server" OnClick="confirmName_Click"  />
                ...
                <asp:View ID= "View8" runat= "server"> 
                                    ...
                                    <asp:Button id="Button12" Text="confirm"  CssClass="confirm2" width="100px" Height ="50px"  runat="server" OnClick="remove2"  /> <br />
                                    <asp:Button id="Button13" class="cancel" Text="Cancel" ValidateRequestMode="Disabled"  CssClass="confirm3" width="100px" Height ="50px"  runat="server" OnClick="cancel" UseSubmitBehavior="False"    />
                                       <h4 class="uploadtxt"> Verify your password</h4>
                                       <asp:TextBox ID="TextBox10" runat="server" required="true" placeholder="Enter your password" CssClass="txtname2"></asp:TextBox>
                              </asp:View>
