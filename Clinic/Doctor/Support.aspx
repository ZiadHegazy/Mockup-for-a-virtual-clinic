<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Support.aspx.cs" Inherits="Clinic.Doctor.Support" %>
       ...
       <ul>
           ...
           <li id="addpubLabel" runat="server" class="normal" ><a href="MyPatients.aspx"  >Patients</a>
                      ...
                      <li id="Li1" runat="server" class="normal" ><a href="DiscussionDoctor.aspx"  >Discussion Board</a> 
                                             ...
                                             <div class="loginbox3">
                    <label  class="p4" > Support Inbox </label>
            <label  class="p5" > You Reported Patient 1 For Posting Inappropriate Content </label>
           <label  class="p6" >IN REVIEW </label>
            </div>
