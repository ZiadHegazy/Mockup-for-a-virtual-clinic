<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DReschedule.aspx.cs" Inherits="Clinic.Doctor.DReschedule" %>

<!DOCTYPE html>
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title></title>
    <link href="DReschedule.css" rel="stylesheet" />
</head>
         ...
         -->
            ...
            <img src="../img/back.png"  alt =" Alternative Text" class ="back"/> 
             <asp:Button Text="back"  CssClass="backbtnnotv" runat="server" OnClick="back" />
                                      ...
                                      <div class="loginbox3">
                    <label  class="p4" > Change The Appointment Time ! </label>
         <asp:TextBox  runat ="server" CssClass="txtname" ID="text" TextMode="DateTimeLocal" />
