<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Question.aspx.cs" Inherits="Clinic.Doctor.Question" %>
           ...
           <li id="addpubLabel" runat="server" class="normal"> <a href="DiscussionDoctor.aspx"  >Discussion Board</a>
            <!-- <div id="hidden_area2"  runat="server" class="hidden_area2">student does not have any on going thesis</div>
              -->
                               ...
                               <div class="loginbox3">
                    <label  class="p4" > QUESTIONS ! </label>
         <asp:TextBox  runat ="server" CssClass="txtname" placeholder=" Write Your Quistion Here" ID="text" />
