<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DiscussionPost.aspx.cs" Inherits="Clinic.Doctor.Post" %>
   ...
   <div class ="loginbox" runat="server" id="loginbox"> 
       ...
       <div class="discbox">
           <asp:Image ID="Image1" src="../img/post1.png" Width="40%" Height="250px" runat="server" />
                   <asp:Button ID="report" runat="server" Text="Report " Width="90px" Height="40px" CssClass="btnsubmit333" OnClick="report_Click"/>
