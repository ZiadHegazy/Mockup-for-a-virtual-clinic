<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PatientMedHes.aspx.cs" Inherits="Clinic.Doctor.PatientMedHes" %>
...
<head runat="server">
    <title></title>
        <link href="PatientMedHes.css" rel="stylesheet" />
</head>
            <style>
    ...
    <form id="form1" runat="server">
      ...
      <div class="translateUp10">
       ...
       <ul>
        ...
        <img src="../img/form1.png"  alt =" Alternative Text" class ="avatar4"/>
                     <style>
            .vl {
        ...
        <h1>Medical History</h1>
         ...
         <br /><br />
         <asp:CheckBox ID="CheckBox3" Enabled="false" CssClass="lblcard3" runat="server" Text="Asthma" OnCheckedChanged="CheckBox1_CheckedChanged" Checked="true"/> 
           <asp:CheckBox ID="CheckBox4" Enabled="false"  CssClass="lblcard3" runat="server" Text="Diabetes" OnCheckedChanged="CheckBox1_CheckedChanged" Checked="true" />  
            <br /><br /><br />
        <asp:Label ID="Label3" Text="Current medications?" CssClass="lblcard" runat ="server" />
           <asp:CheckBox ID="CheckBox2" Enabled="false"  CssClass="lblcard3" runat="server" Text="No" OnCheckedChanged="CheckBox1_CheckedChanged" Checked="true" />  
        <br /><br /><br />
           <asp:Label ID="Label4" Text="Allergies?" CssClass="lblcard" runat ="server" />  
           <asp:CheckBox ID="CheckBox6" Enabled="false"  CssClass="lblcard3" runat="server" Text="No" OnCheckedChanged="CheckBox1_CheckedChanged" Checked="true" />  
    <br /> <br /><br />
                 </div>
