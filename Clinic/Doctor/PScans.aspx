<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PScans.aspx.cs" Inherits="Clinic.Doctor.PScans" %>

<!DOCTYPE html>
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title></title>
        <link href="PScans.css" rel="stylesheet" />
...
<body>
 <div class ="loginbox"> 
     ...
     <div class="loginboxWhite">
        <img src="../img/scan.png"  alt =" Alternative Text" class ="avatar3"/>
                     <style>
            .vl {
        ...
        <div class="text">
              ...
              <asp:Button Text="View All" CssClass="button33" runat="server" OnClick="bloodScanDetails"/>
              <br />
              <asp:Label ID="Label1" Text="X-Rays:    " CssClass="lblcard" runat ="server" />
              <asp:Button Text="View All" CssClass="button34" runat="server" OnClick="xScanDetails"/>
              <br />
              <asp:Label ID="Label2" Text="CT-scans:    " CssClass="lblcard" runat ="server" />
              <asp:Button Text="View All" CssClass="button35" runat="server" OnClick="noScans"/>
              <br />
              <asp:Label ID="Label3" Text="MRI-scans:      " CssClass="lblcard" runat ="server" />
              <asp:Button Text="View All" CssClass="button36" runat="server" OnClick="noScans"/>
              <br />
