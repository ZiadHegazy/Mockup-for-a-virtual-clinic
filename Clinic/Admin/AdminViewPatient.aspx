<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdminViewPatient.aspx.cs" Inherits="Clinic.AdminViewPatient" %>
...
<body class="body">
    ...
    <form id="form1" runat="server">
        ...
        <div>
            ...
            <asp:Image ID="Image3" runat="server" src="../img/patient-doctor.png" />
            
            <asp:Image ID="Image2" runat="server" src="../img/patient-doctor.png" />
            
        </div>
        <asp:Label ID="Label1" runat="server" Text="Ziad Hegazy"></asp:Label>
        <asp:Label ID="Label2" runat="server" Text="Mohamed Salama"></asp:Label>
        <asp:Label ID="Label3" runat="server" Text="Karim Abozeid"></asp:Label>
        ...
        <p>
            <asp:Button class="button1" ID="Button4" runat="server" OnClick="Button4_Click" Text="Ban Patient" />
        </p>
        <p>
            <asp:Button class="button1" ID="Button5" runat="server" OnClick="Button5_Click" Text="Ban Patient" />
        </p>
        <p>
            <asp:Button class="button1" ID="Button6" runat="server" OnClick="Button6_Click" Text="Ban Patient" />
        </p>
    </form>
</body>
</html>
