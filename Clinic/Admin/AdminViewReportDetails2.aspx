<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdminViewReportDetails2.aspx.cs" Inherits="Clinic.AdminViewReportDetails2" %>
...
<body class="body">
     ...
     <asp:Button class="button1" ID="Button5" runat="server" Text="View Post" OnClick="Button5_Click"  />
    ...
    <asp:Label ID="Label6" runat="server" Text="The Reported person posted a bad post in the discussion board"></asp:Label> 
</body>
</html>