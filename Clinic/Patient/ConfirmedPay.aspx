<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ConfirmedPay.aspx.cs" Inherits="Clinic.ConfirmedPay" %>
...
<li  >    <div class="translateUp20"> <div class="mynav_dropdownAppointment">
           ...
           <li class="normal"> <a href="PatientSearch.aspx"  ><h2>SEARCH</h2></a></li>
                    ...
                    <div class ="confirmedPayDiv"> 
                        <br /><br />

          <asp:Button ID="BackButton" CssClass="donePay" runat="server" Text="Done" OnClick="BackButton_Click" />
            <br /><br />
            <img src="../img/PaymentSuccess.jpg"  alt =" Alternative Text" class ="SuccesfulPay"/>
            <br /><br />
