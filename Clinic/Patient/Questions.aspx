<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Questions.aspx.cs" Inherits="Clinic.Patient.Questions" %>
...
<head runat="server">
    <title></title>
    <link href="ReportIssueP.css" rel="stylesheet" />
</head>
<body >
...
<li  >    <div class="translateUp20"> <div class="mynav_dropdownAppointment">
           ...
           <asp:Label ID="Label1" runat="server" Text="Questions?" CssClass="textat"></asp:Label>
           <asp:TextBox ID="TextBox1" CssClass="txtemail22" runat="server" Width="100%" Height="80%" TextMode="MultiLine"  style = "resize:none" OnTextChanged="TextBox1_TextChanged"></asp:TextBox>
        <asp:Button ID="Button2" runat="server" Text="Submit" Width="117px" Height="40px" CssClass="btnsubmitt33" OnClick="confirm_Click"/>
    </div>
    </form>
</body>
</html>
