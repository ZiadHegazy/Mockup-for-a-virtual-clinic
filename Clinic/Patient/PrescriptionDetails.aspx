<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PrescriptionDetails.aspx.cs" Inherits="Clinic.Patient.PrescriptionDetails" %>
...
<li  >    <div class="translateUp20"> <div class="mynav_dropdownAppointment">
    ...
    <form runat="server">
           ...
           <h1>Prescription 1</h1>
           <img src="../img/883.png"  alt =" Alternative Text" class="scanImage"/> 
           </div>
<%--           <asp:Button CssClass="backScan" Text="Back" runat="server" OnClick="backAppDetails" />--%>
            <img src="../img/back.png"  alt =" Alternative Text" class ="back"/> 
             <asp:Button Text="back"  CssClass="backbtnnotv" runat="server" OnClick="backAppDetails"   />    </form>
