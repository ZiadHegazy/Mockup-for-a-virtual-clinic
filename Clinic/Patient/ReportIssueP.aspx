<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ReportIssueP.aspx.cs" Inherits="Clinic.Patient.ReportIssueP" %>
...
<li  >    <div class="translateUp20"> <div class="mynav_dropdownAppointment">
           ...
           <asp:Label ID="Label1" runat="server" Text="What do you want to report :" CssClass="textat"></asp:Label>
        ...
        <asp:Button ID="Button2" runat="server" Text="Submit Report " Width="117px" Height="40px" CssClass="btnsubmitt33" OnClick="confirm_Click"/>
    </div>
    </form>
</body>
</html>
