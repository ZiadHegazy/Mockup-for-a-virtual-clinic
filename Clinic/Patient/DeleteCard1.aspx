<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DeleteCard1.aspx.cs" Inherits="Clinic.DeleteCard1" %>
...
<%--            <asp:ImageButton ID="ImageButton3" runat="server" src="../img/VisaCard2.jpg"  alt =" Alternative Text" class ="visaCard2" OnClick="ImageButton3_Click"/>
          <%--<img src="../img/VisaCard2.jpg"  alt =" Alternative Text" class ="visaCard2"/>--%>
            <br /><br />
            <asp:Button ID="Button2" runat="server" CssClass="AddCardDeleted" Text="Add New Card" OnClick="Button2_Click" />
