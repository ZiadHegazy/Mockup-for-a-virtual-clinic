<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DiscussionPostPatient.aspx.cs" Inherits="Clinic.Patient.DiscussionPost" %>
...
<li  >    <div class="translateUp20"> <div class="mynav_dropdownAppointment">
       ...
       <div class="discbox">
           <asp:Image ID="Image1" src="../img/post1.png" Width="40%" Height="250px" runat="server" />
                   <asp:Button ID="Button1" runat="server" Text="Report " Width="90px" Height="40px" CssClass="btnsubmit333"/>
